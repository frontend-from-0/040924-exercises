...
const filteredProducts = productsExercise6.filter((product) => {
...
const filteredNumbers = numbersExercise7.filter((number) => {
  return number % 3 === 0;
});
...
const filteredWords = wordsExercise8.filter((word) => {
...
const filteredUsers = usersExercise10.filter((user) => {
