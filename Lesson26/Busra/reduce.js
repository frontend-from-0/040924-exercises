...
const maxNumber = numbersEx2.reduce((accumulator,
    currentValue) => Math.max(accumulator,currentValue), -Infinity);
...
const average = numbersEx4.reduce((acc,val)=> acc + val, 0) / numbersEx4.length;
console.log(average);
