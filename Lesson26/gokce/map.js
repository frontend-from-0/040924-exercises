...
const userMailAdress = usersExercise8.map((user) => user.email);
...
const bookTitlesAuthor = booksExercise9.map(
  (book) => `${book.title}-${book.author}`
);
console.log(bookTitlesAuthor);
