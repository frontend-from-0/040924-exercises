...
const sum = numbersEx1.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
console.log(sum); 
...
const max = numbersEx2.reduce((accumulator, currentValue) => Math.max(accumulator, currentValue), -Infinity);
console.log(max); 

// Exercise 4:
// Calculate the average of all numbers in the given array.
const numbersEx4 = [10, 20, 30, 40, 50];
const average = numbersEx4.reduce((accumulator, currentValue) => accumulator + currentValue, 0) / numbersEx4.length;
console.log(average); 