...
document.getElementById('update-image').addEventListener('click', function() {
  document.getElementById('profile-pic').src = 'https://images.unsplash.com/photo-1580894895938-bd31a62ed8ba?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTAyfHxzb2Z0d2FyZSUyMGRldmVsb3BlcnxlbnwwfHwwfHx8MA%3D%3D';
});
