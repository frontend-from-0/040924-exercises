...
let testArray = [0, `hello`, false, true, NaN, 26, ``, `flower`, undefined, null, 42];
...
let result2 = flattenArray([[1, 2], [3, 4], [5, 6]]);
console.log(result2);
...
updateTodoList(["Shopping", "Cleaning", "Studying", "Cooking"], 1, 2, "Reading", "Exercising");
