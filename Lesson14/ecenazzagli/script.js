...
console.log(`${herName} (${herAge}) lives in ${herCity}`);
...
// CODE HERE
const firstName="EceNaz";
const lastName="Zagli";
...
console.log(counterEx22+=1);
console.log(counterEx22=counterEx22+1);
...
// CODE HERE
let numberEx9 = 6;
console.log('Current value='+ numberEx9);
...
let numberEx10=8;
console.log("Current value=" + numberEx10);
console.log("Increasemented value=" + numberEx10++);
...
let aEx27 = 2;
let bEx27 = 3;
const resoultEx27 = ++aEx27 + bEx27;
console.log(resoultEx27);