...
const nameExercise16 = "Alice"; //it gives an error because the "name" variable was previously defined with a different content,so I defined a different variable name
const age = 30;
const cityExercise16 = "Paris";
console.log(nameExercise16 + " (" + age + ") " + "Lives in " + cityExercise16);
...
counterEx22 = counterEx22 + 1; // first method
console.log(counter);

counterEx22 +=1;  // second method
console.log(counterEx22);

counterEx22++; // third method
console.log(counterEx22);

// 23. Declare initialTemperature=20. Increase it by 5 and log the result.
let initialTemperature = 20;
initialTemperature = initialTemperature + 5;
